...
public class CitaLibroController extends CommonController<CitaLibro, CitaLibroService> {
    ...
    public CommonsResponse<CitaLibro> editar(@Valid @RequestBody CitaLibro citaLibro, BindingResult result, @PathVariable Long id) {
        ...
        if (citaLibroO.isPresent()) {
            ...
            if (!libroO.isPresent()) {
                return new CommonsResponse<CitaLibro>(ResponseConstants.NOT_OK, String.valueOf(HttpStatus.NOT_FOUND),
            ...
            return new CommonsResponse<CitaLibro>(ResponseConstants.SUCCESS, String.valueOf(HttpStatus.CREATED), MessagesConstants.MODIFIED_MSG,
